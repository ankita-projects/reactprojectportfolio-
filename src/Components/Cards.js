        ...
        <div className="container px-5 py-10 mx-auto text-center lg:px-40">
          <div className=" flex-col w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-black">
              I'm currently pursuing a full stack web application development
              program from the Helsinki business college. The course curriculum
              includes web frontend development in Reactjs and backend in
              Nodejs, PHP’s Symfony framework. My approach for learning is by
              doing things. As a result of this I have collected a decent
              selection of small web applications projects deployed on GitHub,
              Heroku, and AWS. </p>
              <div className="git">
              <a href="https://github.com/ankita-projects">GitHub link</a>
              </div>     
          </div>
        </div>
